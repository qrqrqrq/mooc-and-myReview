...
// 常量
import { HTTP_GET, CONTENT_TYPE_FORM_URLENCODED, CONTENT_TYPE_JSON } from "./constants";
...
class Ajax {
    ...
    isSendData() {
        ...
        if (method.toLowerCae() === HTTP_GET.toLowerCae()) return false;
        return true;
    }
    // 是否发送 FormData 格式的数据
    isFormData() {
